      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-10 mb-16">
          ...
          <div className="md:col-span-2 space-y-6">
            ...
            <div className="flex gap-3">
              <a href="#" className="w-9 h-9 rounded-full bg-zinc-900 border border-white/10 flex items-center justify-center text-zinc-300 hover:text-[#ccff00] hover:border-[#ccff00]/40 transition-colors">
          ...
          <div>
            <h4 className="text-xs font-black text-white uppercase tracking-widest mb-4">LOCATIONS</h4>
            <ul className="space-y-3 text-xs">
        ...
        <div className="pt-8 border-t border-white/10 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs">
          <div className="text-zinc-400">
            © 2026 Hyperfit Gym. All rights reserved. Replicated with Framer fidelity.
          </div>

          <button
            onClick={scrollToTop}
            className="inline-flex items-center gap-2 text-zinc-300 hover:text-[#ccff00] font-bold uppercase tracking-wider transition-colors"
          >
