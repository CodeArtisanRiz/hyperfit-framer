          ...
          {trainers.map((trainer, idx) => (
            ...
            >
              ...
              <div className="h-96 w-full overflow-hidden relative">
                ...
                {/* Experience Badge */}
                <div className="absolute top-4 right-4 bg-black/80 backdrop-blur-md border border-white/10 px-3 py-1 rounded-full text-[10px] font-bold text-[#ccff00] uppercase tracking-wider">
                  {trainer.experience}
                </div>
              </div>
              ...
              <div className="p-6 relative z-10 -mt-12 bg-gradient-to-t from-[#09090c] to-[#09090c]/90 rounded-b-3xl">
                <div className="text-xs font-extrabold text-[#ccff00] uppercase tracking-widest mb-1">
                  {trainer.role}
                </div>
                ...
                <div className="flex items-center gap-3 pt-4 border-t border-white/10">
                  <a href="#" className="w-8 h-8 rounded-full bg-zinc-800 flex items-center justify-center text-zinc-400 hover:text-[#ccff00] hover:bg-zinc-700 transition-colors">
